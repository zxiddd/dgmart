...
import { LayoutDashboard, Users, Store, ShoppingBag, Truck, Tag, Settings, LogOut, MessageSquare, MapPin, X, Bell } from 'lucide-react';
...
export default function Sidebar({ isOpen, onClose }) {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside className={`fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-200 z-50 flex flex-col transition-transform duration-300 ease-in-out md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'
                }`}>
